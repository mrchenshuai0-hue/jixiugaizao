...
import { Search, RotateCcw, Download, Eye, Car, ChevronDown } from 'lucide-react';
import { api } from '../api';
        ...
        <div className="bg-white rounded-lg shadow-sm border border-gray-200 flex flex-col min-h-full">
          ...
          <div className="p-5 border-b border-gray-100">
            <div className="flex flex-wrap gap-4 items-end">
              <div className="w-48">
                <label className="block text-sm text-[#666666] mb-1.5">车牌号码</label>
                <input type="text" className="w-full h-8 px-3 text-sm border border-gray-300 rounded focus:outline-none focus:border-[#419EFF]" placeholder="请输入车牌号" />
              </div>
              <div className="w-48">
                <label className="block text-sm text-[#666666] mb-1.5">车主姓名</label>
                <input type="text" className="w-full h-8 px-3 text-sm border border-gray-300 rounded focus:outline-none focus:border-[#419EFF]" placeholder="请输入车主姓名" />
              </div>
              <div className="w-48">
                <label className="block text-sm text-[#666666] mb-1.5">车辆品牌</label>
                <input type="text" className="w-full h-8 px-3 text-sm border border-gray-300 rounded focus:outline-none focus:border-[#419EFF]" placeholder="请输入品牌" />
              </div>
            ...
            <table className="w-full text-left border-collapse min-w-[1000px]">
              <thead>
                <tr className="bg-gray-50 text-[#333333] text-sm border-b border-gray-200">
                  <th className="px-4 py-3 font-medium">车牌号码</th>
                  ...
                  <th className="px-4 py-3 font-medium">车身颜色</th>
