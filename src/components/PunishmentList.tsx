        ...
        <div className="bg-white rounded-lg shadow-[0_0_10px_0_rgba(0,0,0,0.1)] border border-gray-200 flex flex-col min-h-full">
          ...
          <div className="p-5 border-b border-gray-100">
            <div className="flex flex-wrap gap-4 items-end">
              <div className="w-64">
                <label className="block text-sm text-[#666666] mb-1.5">被处罚单位</label>
              ...
              <div className="w-48">
                <label className="block text-sm text-[#666666] mb-1.5">处罚日期</label>
                <input type="date" className="w-full h-8 px-3 text-sm border border-gray-300 rounded focus:outline-none focus:border-[#419EFF]" />
              </div>
              <div className="w-48">
                <label className="block text-sm text-[#666666] mb-1.5">处罚类别</label>
                <select className="w-full h-8 px-3 text-sm border border-gray-300 rounded focus:outline-none focus:border-[#419EFF] bg-white">
                  ...
                  <option value="责令停业整顿">责令停业整顿</option>
                </select>
              </div>
          ...
          <div className="px-5 py-3 flex justify-between items-center bg-gray-50/50 border-b border-gray-100">
            <div className="text-sm text-[#666666]">共找到 <span className="text-[#419EFF] font-medium">{data.length}</span> 条处罚记录</div>
            <div className="flex space-x-2">
              ...
              <button onClick={onAdd} className="h-8 px-4 bg-[#419EFF] text-white rounded hover:bg-blue-600 transition-colors flex items-center text-sm font-medium">
                <Plus size={14} className="mr-1.5" /> 企业处罚登记
              </button>
            </div>
          </div>
